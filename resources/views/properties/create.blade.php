<x-app-layout>
                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('properties.store') }}">
                        ...
                        <div>
                            ...
                            <select id="fraccionamiento_id" name="fraccionamiento_id" required
                                ...
                                @foreach($fraccionamientos as $fraccionamiento)
                                    <option value="{{ $fraccionamiento->id }}" {{ old('fraccionamiento_id') == $fraccionamiento->id ? 'selected' : '' }}>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="section" class="block mt-1 w-full" type="text" name="section" :value="old('section')" placeholder="Ej. A, B, Norte, Sur…" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="unit" class="block mt-1 w-full" type="text" name="unit" :value="old('unit')" required placeholder="Ej. 12, Lote 5, Casa 3B…" />
    ...
    <script>
        ...
        const selectedOwnerId = '{{ old('owner_id') }}';
