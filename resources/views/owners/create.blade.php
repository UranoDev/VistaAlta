                    ...
                    <form method="POST" action="{{ route('owners.store') }}">
                        ...
                        <div class="block mt-4">
                            <label for="is_committee_member" class="inline-flex items-center">
                                <input id="is_committee_member" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_committee_member" value="1" {{ old('is_committee_member') ? 'checked' : '' }}>
